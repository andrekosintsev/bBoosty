                ...
                <div class="card-body d-flex">
                    <div class="card-post__author d-flex">
                        <div class="d-flex flex-column justify-content-center ml-3">
                            ...
                            <small class="text-muted">Programm verwendet von: ${entry.count} Personen</small>
                            <small class="text-muted">Körperteil: ${entry.bodyPart}</small>
                            <small class="text-muted">Muskelgruppe: ${entry.muscle}</small>
                            <small class="text-muted">Ausrüstung: ${entry.equipment}</small>
